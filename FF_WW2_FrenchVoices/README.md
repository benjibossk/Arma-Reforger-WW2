...
- [x] `Translations_FR.csv` (135 radio protocol lines)
...
- [ ] Generate 135 radio `.wav` recordings (use `generate_voices.py`)
- [ ] Generate 131 FF speech `.wav` recordings (TODO: extend script or add second CSV target)
- [ ] Override `JWK_Voices.acp` to route FF signals 1-100ish to French .wav samples
...
**Total ≈ 266 voice lines to record/synthesize.** Order of priority:
1. Radio protocol (135) — tactical AI chatter heard most often in gameplay
2. AmbientCivilian + Passphrases (46) — for recruitment quests and missions
3. Player + Officer + Quests (60) — narrative-critical dialogue
4. Digits + miscellaneous (25) — low priority callouts
